...
class KrakenFundingAnalyzer:
    ...
    def fetch_tickers(self) -> list[str] | None:
    ...
    def fetch_funding_rates(self, symbol: str) -> list[dict] | None:
    ...
    def calculate_time_span(self, funding_rates: list[dict]) -> tuple[datetime, datetime, timedelta] | None:
